...
Noyon.hhnx<-secr.fit(all.data.Noyon, model=list(D~1, lambda0~1, sigma~1), detectfn="HHN", mask=NoyonMask1)
...
load("./Noyon2013/Noyon-nonEuc-fits3.RData") #Second round analysis (with water and topography)
