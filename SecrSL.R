...
covariates(NemegtMask1)$stdGRIDCODE = scale(covariates(NemegtMask1)$GRIDCODE)
...
AIC(Nemegt.hhn, Nemegt.hhn.DRgd1, Nemegt.hhn.Det_Topo)
#,Nemegt.hhn.Det_Topo1, Nemegt.DRgd.Det_Topo)

coefficients(Nemegt.hhn.DRgd.Det_Topo)
coefficients(Nemegt.hhn.DRgd1)
emegtSurface<-predictDsurface(Nemegt.hhn.DRgd.Det_Topo, se.D=TRUE, cl.D=TRUE)
